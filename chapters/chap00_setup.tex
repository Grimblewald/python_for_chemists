...
To jump straight into Chapter~\ref{chap:basics}, complete only need to complete the essential sections. They should take 15--30 minutes and will give you everything needed to learn to use Python.
...
At minimum, use cloud sync for your \filepath{python\_projects} folder. You might also want to look into using Git, it's worth learning but explaining its use is beyond the scope of this book.
